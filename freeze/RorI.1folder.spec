...
#
# pyinstaller --clean -y freeze/RORI.1folder.spec
#
# The resulting .exe file is placed in the dist/RORI folder.
#
#
...
icon_file = 'freeze\RorI.ico'
if is_darwin:
    icon_file = 'freeze\RorI.icns'
