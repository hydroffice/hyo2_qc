...
#
# pyinstaller --clean -y freeze/UncCalc.1folder.spec
#
# The resulting .exe file is placed in the dist/UncCalc folder.
#
#
...
from hyo2.unccalc import __version__ as unccalc_version
...
icon_file = 'freeze\UncCalc.ico'
if is_darwin:
    icon_file = 'freeze\UncCalc.icns'

a = Analysis(['UncCalc.py'],
             pathex=[],
...
exe = EXE(pyz,
          ...
          name='UncCalc.%s' % unccalc_version,
          debug=False,
          strip=None,
          upx=True,
          console=True,
