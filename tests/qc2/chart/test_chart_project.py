...
class TestQC2ChartProject(unittest.TestCase):
    ...
    def test_init_project_valid_profile(self):
        prj = ChartProject(output_folder=testing.output_data_folder())
        self.assertTrue(prj.active_profile in ChartProject.project_profiles.values())

    def test_init_project_office_profile(self):
        prj = ChartProject(output_folder=testing.output_data_folder(), profile=ChartProject.project_profiles['office'])
        self.assertEqual(prj.active_profile, ChartProject.project_profiles['office'])

    def test_init_project_field_profile(self):
        prj = ChartProject(output_folder=testing.output_data_folder(), profile=ChartProject.project_profiles['field'])
        self.assertEqual(prj.active_profile, ChartProject.project_profiles['field'])
...
def suite():
    ...
    s.addTests(unittest.TestLoader().loadTestsFromTestCase(TestQC2ChartProject))
    return s
