...
class FeatureScanV12:

    def __init__(self, s57: S57File, profile: int = 0, version: str = "2022",
    ...
    def run(self) -> None:
        ...
        if self.checks.version not in ["2019", "2020", "2021", "2022"]:
