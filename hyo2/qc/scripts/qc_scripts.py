...
def run_qc_tools_v3(grid_path, flier_finder, flier_finder_height, holiday_finder, holiday_finder_mode, grid_qa,
                    survey_name):
    ...
    if grid_qa:
        ...
        ret = prj.grid_qa_v5(force_tvu_qc=True, hist_depth=False, depth_vs_density=False, depth_vs_tvu_qc=False)
        print("- passed? %r" % ret)
...
def main():
    ...
    try:
        float_value = float(sys.argv[3])
        flier_finder_height = float_value
    except ValueError:
        pass
    holiday_finder = sys.argv[4] == "1"
    holiday_finder_mode = sys.argv[5]
    ...
    grid_qa = sys.argv[6] == "1"
    survey_name = None
    if sys.argv[7] != "None":
        survey_name = sys.argv[7]
    ...
    run_qc_tools_v3(grid_path=grid_path, flier_finder=flier_finder, flier_finder_height=flier_finder_height,
