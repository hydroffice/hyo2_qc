...
class ValsouTab(QtWidgets.QMainWindow):
    ...
    def _ui_parameters_vcv7(self):
        ...
        self.toggle_specs_v7.valueChanged.connect(self.changed_specs_v7)
        # spacing
    ...
    def _click_valsou_check_v7(self, version):
        ...
        for i, s57_file in enumerate(s57_list):
            ...
            for j, grid_file in enumerate(grid_list):
                ...
                if version in [7, ]:
                    self._valsou_check_v7(grid_file=grid_file, version=version, idx=idx, total=total)
    ...
    def _valsou_check_v7(self, grid_file, version, idx, total):
