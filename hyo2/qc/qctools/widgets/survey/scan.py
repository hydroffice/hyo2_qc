...
class ScanTab(QtWidgets.QMainWindow):
    ...
    def _ui_parameters_fsv8(self):
        ...
        self.toggle_profile_v8.valueChanged.connect(self.click_set_profile_v8)
        # space
        ...
        # noinspection PyUnresolvedReferences
        self.toggle_specs_v8.valueChanged.connect(self.click_set_specs_v8)
        # stretch
        toggle_hbox.addStretch()
        ...
        # noinspection PyUnresolvedReferences
        self.use_mhw_v8.stateChanged.connect(self.change_use_mhw_v8)
        ...
        # noinspection PyUnresolvedReferences
        self.check_sorind_v8.stateChanged.connect(self.change_check_sorind_v8)
        ...
        # noinspection PyUnresolvedReferences
        self.check_sordat_v8.stateChanged.connect(self.change_check_sordat_v8)
    ...
    def click_set_profile_v8(self, value):
        """ Change the profile in use """
        self.prj.active_profile = value
        self.toggle_profile_v8.setValue(value)
        logger.info('activated profile #%s' % value)

    def change_use_mhw_v8(self):
    ...
    def change_check_sorind_v8(self):
    ...
    def change_check_sordat_v8(self):
    ...
    def click_set_specs_v8(self, value):
