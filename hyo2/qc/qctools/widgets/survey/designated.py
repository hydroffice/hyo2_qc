...
class DesignatedTab(QtWidgets.QMainWindow):
    ...
    def _ui_parameters_dsv2(self):
        ...
        text_1 = QtWidgets.QLabel("2017/18")
        ...
        vbox.addLayout(hbox)
        hbox.addStretch()
        text_set_neighborhood = QtWidgets.QLabel("Evaluate neighborhood <font color= #FF0000>[experimental]</font>")
    ...
    def _click_scan_designated(self, version):
        ...
        self.parent_win.change_info_url(Helper.web_url(suffix="survey_designated_scan_%d" % version))
